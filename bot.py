    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/marikitamerapat for support")
                sys.exit()
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/indonesia_viral for support")
            sys.exit()

        self.set_parse_mode("html")
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by 𝙍𝘼𝙍 𝕏 𝙋𝙧𝙤𝙟𝙚𝙘𝙩𝙨\nhttps://t.me/indonesia_viral")
